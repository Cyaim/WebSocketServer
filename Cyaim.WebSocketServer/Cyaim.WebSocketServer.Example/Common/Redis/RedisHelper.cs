...
namespace Cyaim.WebSocketServer.Example.Common.Redis
{
    ...
    public class RedisHelper : IDisposable
    {
        ...
        /// <param name="db"></param>
        public RedisHelper(string connStr, string defaultKey = null, int db = -1)
        {
            ConnectionString = connStr;
            _connMultiplexer = ConnectionMultiplexer.Connect(ConnectionString);
            //DefaultKey = appsetting.RedisConfigs.PreKey;

            RegisterEvent();

            this.db = _connMultiplexer.GetDatabase(db);
        ...
        public bool StringSet(string redisKey, string redisValue, TimeSpan? expried = null)
        {
            ...
            return db.StringSet(redisKey, redisValue, expried);
        }
        ...
        public bool StringSet<T>(string redisKey, T redisValue, TimeSpan? expired = null)
        {
            ...
            return db.StringSet(redisKey, json, expired);
        }
        ...
        /// <param name="expired"></param>
        /// <returns></returns>
        public async Task<string> StringGetAsync(string redisKey, TimeSpan? expired = null)
        {
            redisKey = AddKeyPrefix(redisKey);
        ...
        /// <param name="e"></param>
        public virtual void ConnMultiplexer_ConfigurationChangedBroadcast(object sender, EndPointEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public virtual void ConnMultiplexer_InternalError(object sender, InternalErrorEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public virtual void ConnMultiplexer_HashSlotMoved(object sender, HashSlotMovedEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public virtual void ConnMultiplexer_ConfigurationChanged(object sender, EndPointEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public virtual void ConnMultiplexer_ErrorMessage(object sender, RedisErrorEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public virtual void ConnMultiplexer_ConnectionFailed(object sender, ConnectionFailedEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public virtual void ConnMultiplexer_ConnectionRestored(object sender, ConnectionFailedEventArgs e)
        {
