...
{
    /// <summary>
    /// Geographic location provider using ip-api.com (free tier)
    /// 使用 ip-api.com（免费版）的地理位置提供者
    /// Rate limit: 45 requests/minute for free tier / 免费版限制：每分钟 45 次请求
    /// </summary>
    public class IpApiComGeoLocationProvider : IGeoLocationProvider
    {
        private readonly ILogger<IpApiComGeoLocationProvider> _logger;
        ...
        public IpApiComGeoLocationProvider(
            ILogger<IpApiComGeoLocationProvider> logger,
